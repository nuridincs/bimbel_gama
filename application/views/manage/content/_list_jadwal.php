                        ...
                        <table class="table table-striped table-bordered datatable dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="border-collapse: collapse !important">
                           <thead>
                              <tr role="row">
                                 ...
                                 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Date registered: activate to sort column ascending" style="width: 170px;">Nama Instruktur</th>
                                 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Role: activate to sort column ascending" style="width: 68px;">Jadwal mengajar</th>
                           ...
                           <tbody>
                              ...
                              <tr role="row" class="odd">
                                 <td class="sorting_1"><?= $value['id_materi']; ?></td>
                                 <td><?= $value['id_instruktur']; ?></td>
                                 <td><?= $value['hari'].", ".$value['tanggal'];; ?></td>
                                 <td>
                                    <a class="btn btn-info" href="<?= base_url('site/page/update/jadwal/').base64_encode($value['id']); ?>">
                                        <i class="fa fa-edit "></i>Ubah
                                    </a>
                                    <a href="<?= base_url('site/execute/delete/jadwal/').$value['id']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="fa fa-trash-o "></i>Hapus</a>
                                 </td>
                              </tr>
                               <?php } ?>
                           </tbody>
